...
local sawBlades = {30, 446, 478, 510, 646, 651, 654, 658, 662, 667, 670, 678, 686, 770, 773, 778, 781, 786, 790, 794, 798, 806, 814, 830, 578, 582, 587, 594, 598, 603, 590, 606, 642, 846, 854, 858, 862, 896, 911, 914, 922, 926, 974, 986, 990, 1026, 1029, 1034, 1037, 1042, 1046, 1050, 1053}
local x0, x1, x2, x3, strumLineY = 0, 0, 0, 0, 0
local introEnded = false

function introFade(strum)--0.22625
...
function onBeatHit()
    ...
    for i = 1, 53 do -- aqui esta el famoso script para las sierras (no me lo roben)
